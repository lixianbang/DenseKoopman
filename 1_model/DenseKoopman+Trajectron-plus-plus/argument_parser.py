...
parser.add_argument("--conf",
                    ...
                    type=str,
                    default='A:/func/code/Trajectron-plus-plus-master/Trajectron-plus-plus-master/config/config.json')
...
parser.add_argument("--data_dir",
                    ...
                    type=str,
                    default='A:/func/code/Trajectron-plus-plus-master/Trajectron-plus-plus-master/experiments/processed')

parser.add_argument("--train_data_dict",
                    help="what file to load for training data",
                    type=str,
                    default='mot20_all_data_train.pkl')

parser.add_argument("--eval_data_dict",
                    help="what file to load for evaluation data",
                    type=str,
                    default='mot20_all_data_val.pkl')

parser.add_argument("--log_dir",
                    help="what dir to save training information (i.e., saved models, logs, etc)",
                    type=str,
                    default='A:/func/code/Trajectron-plus-plus-master/Trajectron-plus-plus-master/experiments/logs')
