...
# parser.add_argument("--model", help="model full path", type=str, default='./models/mot20_kpspace_vel')
# parser.add_argument("--checkpoint", help="model checkpoint to evaluate", type=int, default=2000)
# parser.add_argument("--data", help="full path to data file", type=str, default='../processed/mot20_all_data_kpspace_test.pkl')
# parser.add_argument("--output_path", help="path to output csv file", type=str, default='./results/')
parser.add_argument("--output_tag", help="name tag for output file", type=str, default='VSC_kp_vel_12')
# parser.add_argument("--node_type", help="node type to evaluate", type=str, default='PEDESTRIAN')

parser.add_argument("--model", help="model full path", type=str, default='./models/VSC_kp_vel')  ##
parser.add_argument("--checkpoint", help="model checkpoint to evaluate", type=int, default=800)
parser.add_argument("--data", help="full path to data file", type=str, default='../processed/VSC_all_data_kpspace_test.pkl') ######
