...
data_folder_name = 'processed_data_MOT_All'

maybe_makedirs(data_folder_name)
data_columns = pd.MultiIndex.from_product([['position', 'velocity', 'acceleration'], ['x', 'y']])

# Process ETH-UCY
for desired_source in ['mot20_all_data']:
    for data_class in ['test_0119', 'test_0120', 'test_0219', 'test_0220', 'test_0221', 'test_0222',
                       'test_0223', 'test_0363', 'test_0364', 'test_0365', 'test_0366', 'test_0367',
                       'test_0368', 'test_0369', 'test_0370', 'test_0371', 'test_0372', 'test_0373',
                       'test_0519', 'test_0520', 'test_0521', 'test_0522', 'test_0523', 'test_0524',
                       'test_0525', 'test_0526', 'test_0527', 'test_0528', 'test_0529', 'test_0530',
                       'test_0531', 'test_0532']:  #'test', 'train', 'val'
            ...
            for file in files:
                if file.endswith('.txt'):
                    ...
                    if data_class == "train":
                        ...
                        data['pos_x'] = data['pos_x'] + 0.5 * np.random.normal(0,1)
                        data['pos_y'] = data['pos_y'] + 0.5 * np.random.normal(0,1)
